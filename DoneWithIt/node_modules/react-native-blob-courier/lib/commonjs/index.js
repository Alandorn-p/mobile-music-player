...
const stringifyPartsValues = parts => {
  const stringify = part => part.type === 'string' && typeof part.payload === 'object' ? {
    ...part,
...
const uploadBlobFromParts = input => {
  try {
    ...
    return BlobCourier.uploadBlob(sanitizeMultipartUploadData({
      ...input,
...
const onProgress = (taskId, fn, requestSettings) => ({
  ...
  uploadBlob: input => uploadBlob({
    ...input,
    ...requestSettings,
    onProgress: fn,
    taskId
  }),
  uploadParts: input => uploadParts({
    ...input,
    ...requestSettings,
    onProgress: fn,
    taskId
  }),
  useDownloadManagerOnAndroid: downloadManagerSettings => useDownloadManagerOnAndroid(taskId, downloadManagerSettings, {
    ...requestSettings,
    onProgress: fn
  })
});
